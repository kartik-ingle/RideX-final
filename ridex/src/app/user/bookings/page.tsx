...
import { Bike, Calendar, Car, ChevronRight, ChevronRightIcon, IndianRupee, Loader2, MapPin, Phone, Truck, User } from 'lucide-react'
...
function page() {
    ...
    const getVehicleIcon = (vehicleType?: string) => {
        switch(vehicleType?.toLowerCase()) {
            case 'bike': 
                return <Bike className = "w-4 h4 text-gray-400" />
            case 'auto': 
    ...
    return (
        <div className = "min-h-screen bg-gray-50">
            <div className = "bg-white border-p border-gray-200">
                                ...
                                >
                                    ...
                                    <div className = "bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all overflow-hidden">
                                        <div className = "flex items-center gap-3 p-4 bg-linear-to-r from-blue-50 to-indigo-50 border-b border-gray-20">
                                            <div className = "w-12 h-1/2 rounded-full overflow-hidden bg-blue-200 flex-shrink-0 border-2 border-white shadow-sm flex items-center justify-center">
                                            ...
                                            {(b.bookingStatus === "confirmed" || b.bookingStatus === "started" || b.bookingStatus === "completed") && (
                                                <div className = "flex items-center gap-2">
                                                    <button 
                                                        ...
                                                        className = "flex cursor-pointer items-center gap-1 text-sm font-medium text-blue-600 hover:text-blue-700 bg-blue-50 hover:bg-blue-100 px-4 py-1.5 rounded-lg transition-colors"
                                                    >
