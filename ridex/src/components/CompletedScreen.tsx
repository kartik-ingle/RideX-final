        ...
        >
            <div className = "flex-1 flex flex-col items-center justify-center px-6 py-12">
                ...
                >
                    ...
                    <p className = "text-zinc-500 text-sm text-center mb-8">{role === "driver" ? "You have completed the ride" : "You have completed your ride"}</p>
                    ...
                    {booking.user && (
                        <div className = "bg-zinc-900 border border-zinc-800 rounded-2xl p-4 flex items-center gap-3 mb-3">
                            ...
                            <div>
                                ...
                                <p className = "text-white text-sm font-bold">{booking?.user?.name??"i"}</p>
                            </div>
                        </div>
                    )}
                    ...
                    <button
                        onClick = {() => router.push("/")}
                        className = "w-full cursor-pointer border border-zinc-700 text-zinc-400 py-3.5 rounded-2xl text-sm font-semibold hover:bg-zinc-900 transition-colors"
                    >
                        Back to Home
                    </button>
