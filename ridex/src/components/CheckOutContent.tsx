...
import { ArrowDownRight, ArrowRight, Banknote, Bike, Car, CheckCircle, Clock, CreditCard, IndianRupee, Loader2, MapPin, Navigation, Shield, Truck, Wallet, XCircle } from 'lucide-react'
    ...
    <div className = "min-h-screen bg-zinc-100 px-4 py-12">
        <div className = "relative max-w-6xl mx-auto z-10">
            ...
            >
                ...
                <p className = "text-zinc-400 text-sm mt-1.5 font-bold">Review your ride and confirm</p>
            ...
            <div className = "grid lg:grid-cols-2 gap-6">
                ...
                >
                    ...
                    <div className = "p-8 sm:p-10">
                        <div className = "flex items-center justify-between mb-8">
                            <div>
                                <div className = "text-[10px] font-black uppercase tracking-[0.18em] tex-zinc-400 mb-1">SelectedVehicle</div>
                        ...
                        <div className = "flex items-end justify-between pt-6 border-t border-zinc-100">
                            <div>
                                <p className = "text-[10px] font-extrabold uppercase tracking-[0.18em] text-zinc-400 mb-1">Total Fare</p>
                            ...
                            >
                                ...
                                <span className = "text-5xl font-black tracking-tight leading-none text-zinc-900">{fare}</span>
                            </motion.div>
                        </div>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <div className = "flex-1 sm:p-10 flex flex-col">
                        <AnimatePresence mode="wait">
                            {(status == "idle" || status == "rejected") && (
                                ...
                                >
                                    ...
                                    <motion.button
                                        ...
                                        className = "w-full h-14 cursor-pointer mt-8 bg-zinc-900 hover:bg-black disabled:opacity-40 text-white font-black text-sm rounded-2xl flex items-center justify-center gap-2.5 transition-colors shadow-md"
                                    >
                            ...
                            {status == "requested" && (
                                ...
                                >
                                    ...
                                    <div>
                                        <h3 className = "text-xl font-black text-zinc-900 mb-1">Finding you a driver...</h3>
                                        <p className = "text-zinc-400 text-sm font-medium">Waiting for a driver to accept your request</p>
                                    </div>

                                    <motion.div
                                        whileTap = {{scale: 0.9}}
                                        onClick = {handleCancel}
                                        className = "flex items-center gap-2 cursor-pointer text-xs font-bold text-zinc-400 hover:text-zinc-900 transition-colors border border-zinc-200 hover:border-zinc-400 px-4 py-2.5 rounded-xl"
                                    >
                            ...
                            {status == "awaiting_payment" && (
                                ...
                                >
                                    ...
                                    <div>
                                        <h3 className = "text-xl font-extrabold text-zinc-900 mb-1">Driver Accepted</h3>
                            ...
                            {status == "payment" && (
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <h3 className = "text-2xl font-extrabold text-zinc-900">Select Payment Method</h3>
                                    </div>
                                        ...
                                        {[
                                            ...
                                            return (
                                                <motion.div
                                                    ...
                                                    className = {`cursor-pointer w-full flex items-center gap-4 p-4 rounded-2xl border-2 text-left transition-all duration-200 ${active? "bg-zinc-900 border-zinc-900" : "bg-zinc-50 border-zinc-50 hover:border-zinc-400"}`}
                                                >
                                                    ...
                                                    <div className = "flex-1 min-w-0">
                                                        ...
                                                        <p className = {`text-xs font-medium ${active ? "text-zinc-400" : "text-zinc-500"}`}>{p.sub}</p>
                                                    </div>
                                    ...
                                    <motion.button
                                        ...
                                        className = "w-full cursor-pointer h-14 bg-zinc-900 hover:bg-black disabled:opacity-30 text-white font-black text-sm rounded-2xl flex items-center justify-center gap-2.5 transition-colors shadow-md mt-auto"
                                    >
                                ...
                                >
                                    ...
                                    <div>
                                        <motion.h3
                                            ...
                                            className = "text-2xl font-extrabold text-zinc-900 mb-1"
                                        >
                                            Ride Confirmed!
                                        </motion.h3>
                                        ...
                                        <motion.p
                                            ...
                                            className = "text-zinc-400 text-sm font-extrabold max-w-xs"
                                        >
                                    ...
                                    <motion.button
                                        ...
                                        className = "flex cursor-pointer items-center gap-2.5 bg-zinc-900 hover:bg-black text-white font-black text-sm px-8 py-4 rounded-2xl transition-colors shadow-md"
                                    >
                                        Track Your Ride
                                        <ArrowRight size = {16} />
                                    </motion.button>
