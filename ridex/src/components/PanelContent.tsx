        ...
        <div className = "flex flex-col pt-5 pb-4 gap-3">
            ...
            {booking?.user && (
                ...
                >
                    ...
                    <div className = "bg-zinc-950 rounded-2xl flex items-center gap-4">
                        ...
                        <div className = "flex gap-2 mt-2">
                            ...
                            {canChat && (
                                <button
                                    ...
                                    className = {`flex-1 cursor-pointer flex items-center justify-center gap-2 active:scale-[0.97] transition-all py-3 rounded-xl text-sm font-semibold ${chatOpen ? "bg-zinc-200 text-zinc-900" : "bg-zinc-900 hover:bg-zinc-800 text-white"}`}
                                >
            ...
            <div className = "mx-5 lg:mx-6">
                <div className = "bg-zinc-50 border border-zinc-100 rounded-2xl overflow-hidden">
                    <div className = "flex gap-3 p-4 border-b border-zinc-100">
                        ...
                        <div className = "flex-1 min-w-0">
                            <p className = "text-[10px] font-bold text-zinc-400 uppercase tracking-wider mb-0.5">Pick Up</p>
